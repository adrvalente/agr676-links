...
document.querySelector('#publish').onclick=()=>alert('A publicação segura será ativada na próxima etapa, após configurar a GitHub App no Cloudflare Worker.');
checkSession();
